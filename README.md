...
### howler.js lib was used for Audio
...
As a reminder, Humber College has a zero-plagiarism policy - your project's code must be substantially yours. Do not copy code from similar projects or other sources. However, using lines of code from StackOverflow to accomplish general techniques/algorithms is okay - an example would be using StackOverflow as a source for code that replaces a character at a certain position in a string.
